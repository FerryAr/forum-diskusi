...
CREATE TABLE `comment` (
  ...
  CONSTRAINT `comment_ibfk_6` FOREIGN KEY (`id_reply`) REFERENCES `reply` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=latin1;

INSERT INTO `comment` (`id`, `id_reply`, `id_user`, `isi`, `created_at`, `created_by`) VALUES
(15,	1,	1,	'test',	'2021-07-19 15:33:04',	1),
(16,	1,	3,	'test balasan',	'2021-07-21 08:43:18',	3),
(17,	2,	3,	'test balasan #2',	'2021-07-21 08:44:37',	3),
(18,	1,	3,	'',	'2021-08-02 08:47:53',	3),
(19,	1,	1,	'a',	'2021-08-02 16:22:31',	1)
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `id_reply` = VALUES(`id_reply`), `id_user` = VALUES(`id_user`), `isi` = VALUES(`isi`), `created_at` = VALUES(`created_at`), `created_by` = VALUES(`created_by`);
...
(37,	'127.0.0.1',	'ferryakbarardiansyah@gmail.com',	1630295477),
(38,	'127.0.0.1',	'ferryakbarardiansyah@gmail.com',	1630295483),
(39,	'127.0.0.1',	'admin',	1630295488),
(40,	'127.0.0.1',	'admin',	1630295494)
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `ip_address` = VALUES(`ip_address`), `login` = VALUES(`login`), `time` = VALUES(`time`);
...
(2,	'B. Indonesia'),
(3,	'B. Jawa')
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `pelajaran` = VALUES(`pelajaran`);
...
(4,	3,	1,	'woe',	'woy',	1,	'2021-07-13 09:00:36'),
(5,	3,	1,	'test',	'<p><img alt=\"\" src=\"http://127.0.0.1/forum-diskusi/assets/images/pesan/1107908404.png\" style=\"height:768px; width:1366px\" /></p>\r\n',	1,	'2021-07-14 11:52:28'),
(6,	1,	3,	'ha',	'<p>apa cuk</p>\r\n',	1,	'2021-07-14 12:04:26')
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `id_pengirim` = VALUES(`id_pengirim`), `id_penerima` = VALUES(`id_penerima`), `subject` = VALUES(`subject`), `pesan` = VALUES(`pesan`), `is_read` = VALUES(`is_read`), `created` = VALUES(`created`);
...
INSERT INTO `reply` (`id`, `id_thread`, `id_user`, `isi`, `created_at`, `created_by`, `updated_at`, `updated_by`, `reason`, `status`) VALUES
(1,	1017,	1,	'test',	'2021-07-19 15:25:39',	1,	NULL,	NULL,	NULL,	NULL),
(2,	1017,	3,	'test reply',	'2021-07-21 08:44:02',	3,	NULL,	NULL,	NULL,	NULL),
(3,	1017,	3,	'2222',	'2021-08-02 08:44:44',	3,	NULL,	NULL,	NULL,	NULL),
(4,	1017,	3,	'2222',	'2021-08-02 08:45:03',	3,	NULL,	NULL,	NULL,	NULL),
(5,	1017,	3,	'2222',	'2021-08-02 08:46:46',	3,	NULL,	NULL,	NULL,	NULL),
(6,	1017,	3,	'11111',	'2021-08-02 08:47:04',	3,	NULL,	NULL,	NULL,	NULL),
(7,	1018,	3,	'test comment',	'2021-08-05 11:29:18',	3,	NULL,	NULL,	NULL,	NULL),
(8,	1018,	3,	'test',	'2021-08-05 13:08:33',	3,	NULL,	NULL,	NULL,	NULL),
(9,	1018,	3,	'test komen neh',	'2021-08-05 14:25:55',	3,	NULL,	NULL,	NULL,	NULL),
(10,	1021,	3,	'tets',	'2021-08-05 15:08:04',	3,	NULL,	NULL,	NULL,	NULL)
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `id_thread` = VALUES(`id_thread`), `id_user` = VALUES(`id_user`), `isi` = VALUES(`isi`), `created_at` = VALUES(`created_at`), `created_by` = VALUES(`created_by`), `updated_at` = VALUES(`updated_at`), `updated_by` = VALUES(`updated_by`), `reason` = VALUES(`reason`), `status` = VALUES(`status`);
...
(1,	'127.0.0.1',	'administrator',	'$2y$10$ee7uKgpWMcDWkMKc2qtSXuTlMhCycDBNWUCF4/U/qLkUNOONfomOO',	'admin@admin.com',	NULL,	'',	NULL,	NULL,	NULL,	NULL,	NULL,	1268889823,	1628057908,	1,	'Admin',	'istrator',	'ADMIN',	'0',	'17a3db0f18e728f0447bd3fd3631a063.jpg'),
(3,	'127.0.0.1',	'azrl78',	'$2y$10$.DxblHlinBWcyfSK8JFyUehdESaek629Y00zwafV.VEwflsZW487m',	'ferryakbarardiansyah@gmail.com',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	1625622862,	1630143412,	1,	'Azriel',	'Akbar',	'mboh',	'08888888888',	'76776556_1404306159736687_6385862615276453888_n1.jpg'),
(4,	'127.0.0.1',	NULL,	'$2y$10$aWiTgdyz6wqs8Wf/0bC7DOpqn.RFitxdYTXdn5Wm1GNmgldBYe0Bu',	'test@test.com',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	1625897343,	1630295502,	1,	'test',	'test',	'test',	'088888',	NULL),
(5,	'127.0.0.1',	NULL,	'$2y$10$liToVPUvK05mFUEEv8QwbO3//r5j9eCV7fHrLnk0VOJA1HO.o/9W2',	'test2@test.com',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	1626232482,	1626232500,	1,	'test2',	'test2',	'',	'0',	NULL),
(9,	'127.0.0.1',	NULL,	'$2y$10$N./oCACa3t/ijhVtkJY2X.bPJejc/dUvfhPoDICmYNzz/gWuKTqc6',	'azrl@gmail.com',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	1627890954,	NULL,	1,	'Azriel',	'Akbar',	'',	'08080',	'76776556_1404306159736687_6385862615276453888_n.jpg')
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `ip_address` = VALUES(`ip_address`), `username` = VALUES(`username`), `password` = VALUES(`password`), `email` = VALUES(`email`), `activation_selector` = VALUES(`activation_selector`), `activation_code` = VALUES(`activation_code`), `forgotten_password_selector` = VALUES(`forgotten_password_selector`), `forgotten_password_code` = VALUES(`forgotten_password_code`), `forgotten_password_time` = VALUES(`forgotten_password_time`), `remember_selector` = VALUES(`remember_selector`), `remember_code` = VALUES(`remember_code`), `created_on` = VALUES(`created_on`), `last_login` = VALUES(`last_login`), `active` = VALUES(`active`), `first_name` = VALUES(`first_name`), `last_name` = VALUES(`last_name`), `company` = VALUES(`company`), `phone` = VALUES(`phone`), `avatar` = VALUES(`avatar`);
