...
(11,	'127.0.0.1',	'ferryakbarardiansyah@gmail.com',	1626334498);
...
CREATE TABLE `reply` (
  ...
  CONSTRAINT `reply_ibfk_5` FOREIGN KEY (`status`) REFERENCES `reply` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=latin1;

INSERT INTO `reply` (`id`, `id_thread`, `id_user`, `isi`, `created_at`, `created_by`, `updated_at`, `updated_by`, `reason`, `status`) VALUES
(19,	1017,	4,	'<p>a</p>\r\n',	'2021-07-15 10:14:07',	4,	NULL,	NULL,	NULL,	NULL),
(29,	1017,	1,	'<p>adad</p>\r\n',	'2021-07-15 15:21:11',	1,	NULL,	NULL,	NULL,	19),
(30,	1017,	1,	'<p>asddasasdasd</p>\r\n',	'2021-07-15 15:21:19',	1,	NULL,	NULL,	NULL,	29),
(31,	1017,	1,	'<p>d</p>\r\n',	'2021-07-15 15:27:43',	1,	NULL,	NULL,	NULL,	19);
...
(1,	'127.0.0.1',	'administrator',	'$2y$10$c8Tzq3RVBcaAZi.rd5VZ5eonGe4gmew7XV6v68yEDyCIWW6..qcL6',	'admin@admin.com',	NULL,	'',	NULL,	NULL,	NULL,	NULL,	NULL,	1268889823,	1626404831,	1,	'Admin',	'istrator',	'ADMIN',	'0'),
(3,	'127.0.0.1',	'azrl78',	'$2y$10$LbbQFuqiFZMafP3RqrsxdedXIRzbmK41LIcSKsf9TMc6/7ls8RYpG',	'ferryakbarardiansyah@gmail.com',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	1625622862,	1626232681,	1,	'Azriel',	'Akbar',	'mboh',	'08888888888'),
(4,	'127.0.0.1',	NULL,	'$2y$10$aWiTgdyz6wqs8Wf/0bC7DOpqn.RFitxdYTXdn5Wm1GNmgldBYe0Bu',	'test@test.com',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	1625897343,	1626313206,	1,	'test',	'test',	'test',	'088888'),
(5,	'127.0.0.1',	NULL,	'$2y$10$liToVPUvK05mFUEEv8QwbO3//r5j9eCV7fHrLnk0VOJA1HO.o/9W2',	'test2@test.com',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	1626232482,	1626232500,	1,	'test2',	'test2',	'',	'0');
