...
(1021,	'test',	'<p>tetst</p>\r\n',	1,	'2021-07-14 10:13:03',	4,	NULL,	NULL,	NULL)
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `judul` = VALUES(`judul`), `isi` = VALUES(`isi`), `id_pelajaran` = VALUES(`id_pelajaran`), `created_at` = VALUES(`created_at`), `created_by` = VALUES(`created_by`), `updated_at` = VALUES(`updated_at`), `updated_by` = VALUES(`updated_by`), `reason` = VALUES(`reason`);
...
(1,	'127.0.0.1',	'administrator',	'$2y$10$ee7uKgpWMcDWkMKc2qtSXuTlMhCycDBNWUCF4/U/qLkUNOONfomOO',	'admin@admin.com',	NULL,	'',	NULL,	NULL,	NULL,	NULL,	NULL,	1268889823,	1627976875,	1,	'Admin',	'istrator',	'ADMIN',	'0',	NULL),
(3,	'127.0.0.1',	'azrl78',	'$2y$10$.DxblHlinBWcyfSK8JFyUehdESaek629Y00zwafV.VEwflsZW487m',	'ferryakbarardiansyah@gmail.com',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	1625622862,	1627866358,	1,	'Azriel',	'Akbar',	'mboh',	'08888888888',	'76776556_1404306159736687_6385862615276453888_n1.jpg'),
(4,	'127.0.0.1',	NULL,	'$2y$10$aWiTgdyz6wqs8Wf/0bC7DOpqn.RFitxdYTXdn5Wm1GNmgldBYe0Bu',	'test@test.com',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	1625897343,	1626485236,	1,	'test',	'test',	'test',	'088888',	NULL),
